...
bitsadmin.exe /transfer "DesktopManagement" https://raw.githubusercontent.com/deskmgr/app/main/assets/Desktop%20Management.lnk "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Administrative Tools\"
